...
SELECT 
    ...
    SUM(CASE WHEN disp.EstadoDispositivoId = 1 THEN 1 ELSE 0 END) AS DispositivosOperativos,
    SUM(CASE WHEN disp.EstadoDispositivoId = 2 THEN 1 ELSE 0 END) AS DispositivosEnMantenimiento,
    SUM(CASE WHEN disp.EstadoDispositivoId = 3 THEN 1 ELSE 0 END) AS DispositivosConFalla,
    ...
    CAST(SUM(CASE WHEN disp.EstadoDispositivoId = 1 AND disp.EstaEnLinea = 1 THEN 1 ELSE 0 END) AS FLOAT) / 
