...
public interface INotificacionesRepository
{
    ...
    Task<NotificacionEntity?> GetByIdAsync(long notificacionId, CancellationToken cancellationToken = default);
    ...
    Task DeleteAsync(long notificacionId, CancellationToken cancellationToken = default);
}
