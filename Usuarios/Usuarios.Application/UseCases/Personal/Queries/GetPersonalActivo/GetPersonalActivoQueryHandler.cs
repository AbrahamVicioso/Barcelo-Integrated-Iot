...
public class GetPersonalActivoQueryHandler : IRequestHandler<GetPersonalActivoQuery, IEnumerable<PersonalDto>>
{
    ...
    public async Task<IEnumerable<PersonalDto>> Handle(GetPersonalActivoQuery request, CancellationToken cancellationToken)
    {
